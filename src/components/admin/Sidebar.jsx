...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      submenu: [
        { title: "Daftar Konsultasi", path: "/admin/konsultasi" },
        { title: "Tiket Masuk", path: "/admin/konsultasi/tickets" },
        { title: "Riwayat", path: "/admin/konsultasi/history" }
      ]
    },
    {
          ...
          <div className="p-4 border-t border-white/10">
            <div className="flex items-center space-x-3 px-4 py-3 bg-primary-dark rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-300">admin@taxmin.id</p>
              </div>
            </div>
          </div>
        </div>

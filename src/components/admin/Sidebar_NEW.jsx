...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      roles: ['Admin', 'Manager'],
      submenu: [
        { title: "Daftar Konsultasi", path: "/admin/konsultasi", roles: ['Admin', 'Manager'] },
        { title: "Tiket Masuk", path: "/admin/konsultasi/tickets", roles: ['Admin', 'Manager'] },
        { title: "Riwayat", path: "/admin/konsultasi/history", roles: ['Admin'] }
      ]
    },
    {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`fixed top-0 left-0 z-50 h-screen w-64 bg-primary transform transition-transform duration-300 ease-in-out ${
                  ...
                  <div>
                    ...
                    {openSubmenu === index && (
                      <div className="mt-2 ml-8 space-y-1">
                        {filterSubmenuItems(item.submenu)?.map((subItem, subIndex) => (
                          <Link
                            key={subIndex}
                            to={subItem.path}
          ...
          <div className="p-4 border-t border-white/10">
            <div className="flex items-center space-x-3 px-4 py-3 bg-primary-dark rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-300">{user?.email || 'user@taxmin.id'}</p>
                {/* Role Badge */}
